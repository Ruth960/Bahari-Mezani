...
export default function OrderProducts(){
    ...
    return(
         <div className=" py-16 mt-20 text-center"> 
            ...
            <button className="bg-[#009dc4] hover:bg-[#48bf91] text-white font-bold py-3 px-8 rounded-full text-lg shadow-lg transform transition duration-300 hover:scale-105"> {/* Styled button */}
                Place an Order
            </button>
        </div>
    )
